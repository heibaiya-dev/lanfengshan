...
open class FanWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_POWER = "com.heibai.hyw.zaoxueji.widget.POWER"
        const val ACTION_SPEED = "com.heibai.hyw.zaoxueji.widget.SPEED"
        const val ACTION_MUTE = "com.heibai.hyw.zaoxueji.widget.MUTE"
        const val ACTION_OSCILLATE = "com.heibai.hyw.zaoxueji.widget.OSCILLATE"
    }
}
